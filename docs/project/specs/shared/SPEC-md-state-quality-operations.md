...
- TypeScript adapter は Prettier、ESLint、Vitest を代表 toolchain とする。
- Python adapter は Ruff format、Ruff、Pytest を代表 toolchain とする。
- Rust adapter は rustfmt、clippy、cargo test を代表 toolchain とする。
