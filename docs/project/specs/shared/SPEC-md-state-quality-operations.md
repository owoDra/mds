...
- TypeScript は Prettier、ESLint、Vitest を代表 toolchain とする。
- Python は Ruff format、Ruff、Pytest を代表 toolchain とする。
- Rust は rustfmt、clippy、cargo test を代表 toolchain とする。
