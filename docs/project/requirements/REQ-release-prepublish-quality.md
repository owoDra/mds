...
related:
  ...
  - .github/script/release-check.sh
---
...
このリポジトリは GitHub Releases native binary archive と VS Code extension の配布経路について、公開前に artifact、checksum、署名、SBOM、provenance、install smoke test を確認できること。
...
- GitHub Releases native binary archive、VS Code extension package の公開前検証
