...
- `.github/skills/docs-update-architecture/references/best-practices.md`
- `.github/skills/docs-update-architecture/references/architecture.template.md`
- 関連 spec / ADR / validation / tech-stack

## やること

1. 必要なら `ask_user` で変更意図、背景、影響範囲を確認する
