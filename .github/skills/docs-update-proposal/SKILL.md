...
- `.github/skills/docs-update-proposal/references/proposal.template.md`
- `.github/skills/docs-update-proposal/references/best-practices.md`
- 必要に応じて `docs/project/architecture.md`
- 関連する research / requirement / spec / ADR / pattern

## やること

1. 必要なら `ask_user` で背景、提案内容、対象範囲、非目標、採否判断に必要な材料を確認する
...
5. `.github/skills/_shared/document-reference-rules.md` に従い、`docs/project/proposals/index.md` を必ず更新する
