...
- `.github/skills/docs-update-requirement/references/requirement.template.md`
- `.github/skills/docs-update-requirement/references/best-practices.md`
- `docs/project/architecture.md` が存在する場合は参照する
- 関連 spec / ADR / validation

## やること

1. 必要なら `ask_user` で目的、根拠、成功指標、対象範囲、対象外、制約を確認する
2. `docs/project/requirements/` を確認し、重複や矛盾がないか調べる
3. requirement として独立させるべき粒度か判断する
4. `REQ-<category>-<short-title>.md` を作成または更新する
5. `.github/skills/_shared/document-reference-rules.md` に従い、`docs/project/requirements/index.md` を必ず更新する
