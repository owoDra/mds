...
- `.agents/project.md`
- `.github/skills/harness-create-skill/references/SKILL.example.md`
- 既存の `.github/skills/*/SKILL.md`
- `docs/project/glossary/core.md`

## やること

1. 必要なら `ask_user` で skill 名、用途、発動条件、references の要否を確認する
2. プレフィックスを決める
   - `task-`
   - `docs-update-`
   - `harness-`
3. `.github/skills/<skill-name>/SKILL.md` を作成する
