...
- `.github/skills/docs-update-patterns/references/pattern.template.md`
- `.github/skills/docs-update-patterns/references/best-practices.md`
- 関連 requirement / spec / ADR / validation / architecture

## やること

1. 必要なら `ask_user` で目的、適用範囲、非目標を確認する
2. 既存 pattern と重複や矛盾がないか調べる
3. pattern として独立させるべき粒度か判断する
4. `<prefix><slug>.md` を作成または更新する
5. `.github/skills/_shared/document-reference-rules.md` に従い、`docs/project/patterns/index.md` を必ず更新する
