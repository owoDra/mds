...
fn generate_module_root_template(feature_name: &str, labels: &HashMap<String, String>) -> String {
    ...
    format!(
        "<!-- Generated by mds new. -->\n\
         ...
         \n\
         Add a `Source` section only when this root module owns runtime behavior, and keep import or export declarations in that code block instead of duplicate metadata tables.\n"
    )
}
...
fn generate_test_template(feature_name: &str, labels: &HashMap<String, String>) -> String {
    ...
    format!(
        "<!-- Generated by mds new. -->\n\
         ...
         ## {l_test}\n\
         \n\
         ```ts\nimport {{ describe, expect, it }} from 'vitest';\n\n// Import the feature under test from the generated output or package entrypoint.\n\ndescribe('{feature_name}', () => {{\n  it('describes the expected behavior', () => {{\n    expect(true).toBe(true);\n  }});\n}});\n```\n"
    )
}
