...
fn project_files(root: &Path, options: &InitOptions) -> Vec<PlannedFile> {
    ...
    let files = vec![
        ...
        PlannedFile {
            ...
            content: format!(
                "<!-- Generated by mds init. -->\n# Package Root\n\n## {l_purpose}\n\nDescribe the package root module surface.\n\n## API\n\nDescribe the public API and re-exports in prose. Add a `Source` section only when this root module owns runtime behavior, and keep import and export declarations in that code block instead of duplicate tables.\n",
            ),
        },
        PlannedFile {
