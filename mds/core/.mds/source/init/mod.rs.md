...
fn project_files(root: &Path, options: &InitOptions) -> Vec<PlannedFile> {
    ...
    let l_exports = preset.section_label("exports");
    let l_imports = preset.section_label("imports");
    let l_visibility = preset.section_label("visibility");
    let l_from = preset.section_label("from");
    let l_target = preset.section_label("target");
    let l_symbols = preset.section_label("symbols");
    let l_via = preset.section_label("via");
    let l_reference = preset.section_label("reference");
