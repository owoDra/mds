...
```bash
# 1. リポジトリをクローン
git clone https://github.com/owo-x-project/owox-mds.git
cd mds

# 2. Rust workspace のビルドと確認
cargo build --workspace
cargo test --workspace

# 3. VS Code 拡張を変更する場合のみ
...
- first-party の Rust / TypeScript 実装は `mds/*/src`、`mds/*/tests`、`editors/vscode/src` などの checked-in source / test を直接編集してください
- 新しい機能にはテストを追加してください
...
VSCode 拡張を変更した場合は追加で次を実行してください:
