...
- `.opencode/skills/docs-update-plan/references/plan.template.md`
- `.opencode/skills/docs-update-plan/references/phase.template.md`
- `.opencode/skills/docs-update-plan/references/task.template.md`
- `.opencode/skills/docs-update-plan/references/best-practices.md`
- 関連 requirement / spec / ADR / validation / pattern / proposal / research

## やること

1. 必要なら `question` で目的、対象範囲、非スコープ、前提、期限、優先順位、検証可能な成果を確認する
...
7. `.opencode/skills/_shared/document-reference-rules.md` に従い、対応する `index.md` を必ず更新する
